...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO visit_tech (Species,Company_Name,Company_Phone,Date_Of_Operation,Price_Total,Registration_Number) VALUES (:specie, :Company_Name, :phone, :Date_Of_Operations, :Ptotal, :regestration_number)";
    ...
    if ($pdoe) {
        header("location:TechVisit.php?gin=$get");
    } else {
...
<body>
    <div class="container-fluid">
        ...
        <a href="TechVisit.php?gin=<?= $get ?>"><button class="btn btn back ml-5 mt-3 "><span class="glyphicon glyphicon-arrow-left"></span></button></a>
        <div class="row  justify-content-center align-items-center">
           <h3 class="col-12 text-center mb-5 textcolor">Add Visit Tech</h3>
