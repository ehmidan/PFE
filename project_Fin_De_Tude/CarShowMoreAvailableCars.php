...
<body>
  ...
  <div class="p-0 m-0 row" data-aos="fade-down">
      ...
      <a href="Available_Cars.php"><button class="btn back ml-5 mt-3 "><span class="glyphicon glyphicon-arrow-left"></span></button></a>
      <a href="Giniral_Info.php?gin=<?php echo $get ; ?>" class="col-12">
        ...
        <a href="CarDrain.php?gin=<?php echo $get ; ?>" class="col-12">
