...
<h3 class="col-12 text-center mb-5 textcolor">Insurance</h3>
    <table class="table table-gray table-hover mt-5" data-aos="fade-down" >
      ...
      <tbody>
        ...
        $Get_res = $pdo->prepare("SELECT * FROM insurance WHERE Registration_Number = '$get'");
        $Get_res->execute();
    ...
    <div class="row">
      <div class="col-12 text-center"><a href="AddInsurance.php?id=<?= $get ?>"><button class="btn toggeles"><span class="glyphicon glyphicon-plus-sign"></span>Add</button></a></div>
    </div>
